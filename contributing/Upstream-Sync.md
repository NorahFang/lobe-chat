...
Upgrading the Docker deployment version is very simple, just redeploy the latest image of 云智助手. Here are the instructions to perform these steps:

1. Stop and delete the currently running 云智助手 container (assuming the name of the 云智助手 container is `lobe-chat`):
...
2. Pull the latest Docker image of 云智助手:

```fish
docker pull lobehub/lobe-chat
```

3. Redeploy the 云智助手 container using the newly pulled image:
...
>
> Don't worry, all of 云智助手's chat history is stored in your local browser. Therefore, when you redeploy 云智助手 using Docker, your chat history will not be lost.
