...
Welcome to the 云智助手 technical development getting started guide. 云智助手 is an AI conversation application built on the Next.js framework, which integrates a series of technology stacks to achieve diverse functions and features. This guide will provide a detailed introduction to the main technical components of 云智助手 and how to configure and use these technologies in your development environment.
...
The core technology stack of 云智助手 includes:
...
The folder directory structure of 云智助手 is as follows:
