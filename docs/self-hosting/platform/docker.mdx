...
We provide a [Docker image][docker-release-link] for you to deploy the 云智助手 service on your private device.
...
<Steps>
  ...
  Use the following command to start the 云智助手 service with one click:
  ...
  - For the complete list of environment variables supported by 云智助手, please refer to the [Environment Variables](/zh/self-hosting/environment-ariable) section.
