# Deploy 云智助手 with Netlify

If you want to deploy 云智助手 on Netlify, you can follow these steps:

## Deploy 云智助手 with Netlify

<Steps>
  ### Fork the 云智助手 Repository

  Click the Fork button to fork the 云智助手 repository to your GitHub account.
  ...
  Next, select the 云智助手 project:

  <Image alt={'Select the 云智助手 github project'} height={228} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/6c3968a8-fbbb-4268-a587-edaced2d96af'} />
  ...
  <Image alt={'Configure 云智助手 site name'} height={712} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/f3885537-6d43-422f-b1b8-e70732401025'} />

  Click the "Add environment variables" button to add site environment variables:

  <Image alt={'Add 云智助手 site environment variables'} height={537} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/3b607482-4d99-455a-bc10-3090dd4fe3c5'} />
  ...
  <Callout type={'tip'}>
    For a complete list of environment variables supported by 云智助手, please refer to the [📘
  ...
  Upon entering the deployment details, you will see the following interface, indicating that your 云智助手 is currently being deployed. Simply wait for the deployment to complete.

  <Image alt={'云智助手 deployment in progress'} height={325} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/1ed8b13d-046e-47c8-bd61-116ffdf5d01b'} />
  ...
  If your Deploy Log in the interface looks like the following, it means your 云智助手 has been successfully deployed.
  ...
  At this point, you can click on "Open production deploy" to access your 云智助手 site.

  <Image alt={'Access Your 云智助手 Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
