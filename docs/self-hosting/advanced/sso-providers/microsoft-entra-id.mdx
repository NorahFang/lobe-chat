...
<Steps>
  ...
  Go back to the "Microsoft Entra ID" interface, enter "Users", click on "New user", fill in the user information, and click on "Create" to create a user for using 云智助手.

  ### Configure Environment Variables

  When deploying 云智助手, you need to configure the following environment variables:

  | Environment Variable     | Type     | Description                                                                                                                                                                                                                |
  | ------------------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | `ENABLE_OAUTH_SSO`       | Required | Enable single sign-on (SSO) for 云智助手. Set to `1` to enable single sign-on.                                                                                                                                             |
...
<Callout>After successful deployment, users will be able to authenticate and use 云智助手 using the users configured in Microsoft Entra ID.</Callout>
